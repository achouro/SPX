...
@app_callback(Input(component_id= 'site-dropdown', component_property='value'),
              Output(component_id= 'success-pie-chart', component_property='figure'))
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='Launch Site names', 
        title='Total Success Lauches by site')
        return fig
    else:
        filtered_df=spacex_df['Lauch Site'== entered_site]
...
def get_scatter_chart(entered_site, ):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.scatter(spacex_df, x='Payload Mass (kg)', y='class'
        color="Booster Version Category"
        title='Chosen sites {} - payload mass '.format(entered_site))
        return fig
# Run the app
